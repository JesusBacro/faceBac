...
<body>
     <form class="form-horizontal" action="a.php" method="post"><!--boton que va a enviar a la base de datos-->
   <div class="container">
	<div class="mx-auto col-sm-8 main-section" id="myTab" role="tablist">
					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="userList" class="table table-bordered table-hover table-striped">
								...
								<tr>
									<th scope="col"><font size="5">En Comercializadora Bacros, S.A. de C.V., es compromiso brindar servicios de Mantenimiento Preventivo y Correctivo, venta, distribución de refacciones, surtimiento de Equipo Medico y Electromecánico que satisfagan los requisitos de nuestros clientes y los aplicables, a través de un Sistema de Gestión de Calidad que garantice el crecimiento de la organización mediante el proceso de mejora continua.</th>
        ...
        <option value="<?php echo ($_SESSION['nombre']); ?>"><?php echo ($_SESSION['nombre']); ?></option>
             ...
             <select name="labor" >
                 <option value="politica">Política de Calidad</option>

...
if (isset($_POST['from'])) 
{
    ...
    if ($_POST['from']!="" AND $_POST['to']!="") 
    {
        ...
        $query="INSERT INTO eventos VALUES(null,'$titulo','','$clase','$inicio','$final','$inicio_normal','$final_normal', '$dia', '$comida')";
...
border-radius: 50px;
border-style: groove; border-width: 6px;
width: 200px;
height: 85px;
...
border-left: 20px;
border-right: 20px;
width: 1050px;/*cambia lo ancho del calendario*/ */
height: 600px;
...
<center>
                <div class="row">
                        ...
                        <font color="red" face="Arial Black"><div class="page-header"><h2></h2></div></font>
                        <br>
                        <p><center><font face="Arial" size="4">CONTROL DE COMIDAS</font></center></p>
                        <br>
                        <div class="borde">
                            <br>
...
<div class="borde1"><br>
 <center><font color="red" face="Arial Black"><div class="page-header"><h2></h2></div></font></center>
    <center>
                                       <div class="btn-group">
      ...
      <div class="modal-body">
        <form action="" method="post">
                    ...
                    <select class="form-control" name="class" id="tipo">
                        <option value="event-info">Solo</option>
                        <option value="Exito">Exito</option>
                        <option value="Importantante">Importantante</option>

...
mysqli_select_db($con,'id12491651_bac');
 ...
 function Header()
 {
     ...
     $this->Cell(80);
     // Título
     $this->Cell(100,10,utf8_decode('VISIÓN BACRO CORPORATIVO'),1,0,'C');
     // Salto de línea
     $this->Ln(20);
...
$pdf->Cell(0,0,utf8_decode('Ser la mejor empresa que dé, a nivel nacional, productos y servicios integrales, operando con estándares  '),0,1,'L');
$pdf->Cell(10,11,utf8_decode('internacionales y de la más alta calidad que satisfagan a nuestros clientes. '),200,200,'L');

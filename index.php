      ...
      <div class="row">
        <div class="col-xs-12 col-md-4 col-md-offset-4">
          ...
          <fieldset>
            ...
            <legend class="center">B A C R O C O R P</legend>
            ...
            <div class="input-group">
              ...
              <input type="password" autocomplete="off" class="form-control" id="clave" placeholder="Ingresa tu contraseña, solo valores númericos">
            </div>

...
<body>
  ...
  <ul>
    <li><a href="view/USER/index.php"><i class="fas fa-qrcode"></i>ATRAS</a></li>
...
?>
<br><br><br>
<center><input type="button" onclick="location.href='n.php';" value="SIGUIENTE" /></center>
<br>
<center><input type="button" onclick="location.href='view/user/index.php';" value="ATRAS" /></center>
</body>
</html>
